...
const content = `export const ALL_LANGUAGES = ${JSON.stringify(unique, null, 4)};\n`;
fs.writeFileSync('/Users/macbook/Documents/Unified_System/Projects/connect-landing-page/app/data/languages.ts', content);
console.log('Deduplicated: ' + unique.length + ' languages remaining.');
