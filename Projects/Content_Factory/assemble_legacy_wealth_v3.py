...
"""
    ...
    assets = [
        {'image': str(assets_dir / 'scene_1_hook.jpg'), 'keyword': 'business man laptop city office cinematic handheld'},
        ...
        {'image': str(assets_dir / 'scene_4_orchestrator.jpg'), 'keyword': 'epic orchestra conductor silhouette stage lighting'},
    ...
    final_video = orchestrator.run_no_face_pipeline(
        text=script_ru,
        lang="ru",
        output_name="legacy_wealth_v3_hybrid",
        scenes=assets,
        style="impact"
    )
