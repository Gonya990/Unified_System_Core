...
def patch_bot_v2():
    ...
    if old_path in content:
        ...
        print("✅ Patched path in ai_telegram_bot_v2.py")
    else:
        print("⚠️ Path string not found in ai_telegram_bot_v2.py")
...
def patch_ha_controller():
    ...
    if target_import in content and "try:" not in content.split(target_import)[0][-20:]:
        ...
        print("✅ Patched import in ha_controller.py")
    else:
        print("⚠️ Import string mismatch or already patched in ha_controller.py")
