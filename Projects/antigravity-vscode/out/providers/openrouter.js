...
class OpenRouterProvider {
    ...
    constructor() {
        const config = vscode.workspace.getConfiguration('antigravity.providers.openrouter');
        this.apiKey = config.get('apiKey') || '';
        this.model = 'openai/gpt-4o'; // Default, can be switched
    }
    isAvailable() {
        return !!this.apiKey;
    }
    async complete(options) {
        const response = await fetch('https://openrouter.ai/api/v1/chat/completions', {
            ...
            headers: {
                ...
                'HTTP-Referer': 'https://github.com/unified-system/antigravity',
