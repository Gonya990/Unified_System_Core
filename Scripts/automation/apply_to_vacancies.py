...
KEYWORDS = ["vacancy", "job", "position", "hiring", "hr", "recruiter", 
            "משרה", "דרושים", "עבודה", "גיוס", 
            "вакансия", "работа"]
            
EXCLUDED_SENDERS = ["noreply", "no-reply", "donotreply", "notifications", "alerts", 
                   "newsletter", "updates", "linkedin.com", "glassdoor.com", 
                   "indeed.com", "facebookmail.com"]
