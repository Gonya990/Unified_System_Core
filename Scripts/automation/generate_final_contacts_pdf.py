...
def create_pdf():
    ...
    story.append(
        Paragraph(
            "Ниже представлен список компаний и агентств для отправки резюме. Акцент сделан на позиции Operational/Site Manager на Севере Израиля и в крупных технологических компаниях.",
            style_normal,
        )
    )
