...
CLIENT_SECRETS_FILE = str(ROOT_DIR / "Projects/Content_Factory/src/uploaders/.credentials/client_secrets.json")
...
def exchange_code(code):
    try:
        ...
        target_path = ROOT_DIR / "Projects/Content_Factory/src/uploaders/.credentials/youtube_token.json"
