...
Полная security очистка применена к **ОБОИМ** репозиториям.
Все чувствительные данные удалены из Git истории и рабочих директорий.
...
✅ Used `git-filter-repo` to completely remove sensitive files from
   entire history  
